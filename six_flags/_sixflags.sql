...
SELECT "Bloque de inserts";
SOURCE parque.sql;

LOAD DATA LOCAL INFILE 'horario.txt' INTO TABLE horario FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n' (parque_id, fecha, hora_apertura, hora_cierre);

LOAD DATA LOCAL INFILE 'empleado.txt' INTO TABLE empleado FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n';

SOURCE excursion.sql;

SOURCE alianza.sql;

SOURCE tour.sql;

SOURCE empleado_tour.sql;

SOURCE servicio.sql;

LOAD DATA LOCAL INFILE 'renta.txt' INTO TABLE renta FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n' (contacto_nombre, contacto_telefono, fecha_hora_inicio, fecha_hora_fin);

LOAD DATA LOCAL INFILE 'renta_detalle.txt' INTO TABLE renta_detalle FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n';

SOURCE evento.sql;

SOURCE villa.sql;

SOURCE categoria_restaurante.sql;

SOURCE restaurante.sql;
  
SOURCE categoria_tienda.sql;

SOURCE tienda.sql;

SOURCE mercancia.sql;

SOURCE tienda_mercancia.sql;

SOURCE tipo_atraccion.sql;

SOURCE nivel_emocion.sql;

SOURCE fabricante.sql;

SOURCE atraccion.sql;

LOAD DATA LOCAL INFILE 'ciclo.txt' INTO TABLE ciclo FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n';

SOURCE categoria_producto.sql;

SOURCE producto.sql;

SOURCE paquete.sql;

SOURCE beneficio.sql;

SOURCE producto_beneficio.sql;

SOURCE espectaculo.sql; -- agregar espectaculo

LOAD DATA LOCAL INFILE 'comprador.txt' INTO TABLE comprador FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n' (nombre, telefono, correo_electronico);

LOAD DATA LOCAL INFILE 'venta.txt' INTO TABLE venta FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n' (comprador_id, fecha, metodo_pago);

LOAD DATA LOCAL INFILE 'venta_detalle.txt' INTO TABLE venta_detalle FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n';

LOAD DATA LOCAL INFILE 'ticket.txt' INTO TABLE ticket FIELDS TERMINATED BY '\t' LINES TERMINATED BY '\r\n';
-- tarjeta
-- tarjeta_complemento
